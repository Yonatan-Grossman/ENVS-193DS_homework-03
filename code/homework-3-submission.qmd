...
ggplot(data_clean,
       aes(x = presence_of_a_non_work_stressor_y_n,
           ...
           color = presence_of_a_non_work_stressor_y_n, #setting axes titles, and letting me manually choose the color and shapes
...
```{r}
sketch <- image_read("C:/Users/16177/193 DS/ES 193DS/git/ENVS-193DS_homework_3/ENVS-193DS_homework-03/WhatsApp Image 2025-05-28 at 2.57.12 PM.jpeg") #loading in the photo

sketch_scaled <- image_scale(sketch, "800") #scaling the photo

print(sketch_scaled) #print photo
```

## c.

```{r}
draft <- image_read("C:/Users/16177/193 DS/ES 193DS/git/ENVS-193DS_homework_3/ENVS-193DS_homework-03/WhatsApp Image 2025-05-28 at 9.01.04 PM.jpeg") #loading in the photo
