...
## b.
```{r}
personal_data <- read.csv("data/Personal data - Sheet1.csv") #reading in the personal data
...
```{r}
sketch <- image_read("WhatsApp Image 2025-05-28 at 2.57.12 PM.jpeg") #loading in the photo
